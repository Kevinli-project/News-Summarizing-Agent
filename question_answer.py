...
"""
        ...
        QA_system_prompt += "You will summarize the news like Cleo Abram, in an engaging way targeting casual readers. \n"
...
List of references:
1) [S&P Global - Week Ahead Economic Preview](https://www.spglobal.com/marketintelligence/en/mi/research-analysis/week-ahead-economic-preview.html)
...
Lastly list out the articles which you referenced, using clickable Markdown links in this format: [Source Name - Article Title](URL)
...
List of references:
1) [Boston Dynamics - Atlas](https://bostondynamics.com/atlas)
2) [EuroNews - Boston Dynamics Robot Atlas](https://www.euronews.com/next/2023/01/21/watch-boston-dynamics-humanoid-robot-atlas-jump-grab-throw-and-do-a-multi-axis-flip)
3) [Rose City Robotics - What Boston Dynamics New Atlas Tells Us](https://rosecityrobotics.com/articles/when-robots-start-to-react-what-boston-dynamics-new-atlas-tells-us-about-the-state-of-robotics)
"""

        # General guidelines
        QA_system_prompt += "\n\n\nIn general, the typical flow is that news articles is presented to the user.\n"
        QA_system_prompt += "User will asked about one of the article presented. To give a general idea, calling visit_website is usually enough. If that article is from a pay-walled source, then you must to call find_internet_articles instead.\n"
        ...
        QA_system_prompt += "If you have used any sources, you should list them under references using clickable Markdown links like [Source - Title](URL). If you didn't use any sources in your answer, then don't list any references and just say so. Do not make up any references.\n"
